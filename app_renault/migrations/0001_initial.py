# Generated by Django 5.0.6 on 2024-08-15 14:48
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('id_piloto', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='app_renault.piloto')),
                ('id_risco', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='app_renault.risco')),
            ],
        ),
        migrations.AddField(
            model_name='risco',
            name='id_usuario',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='app_renault.usuario'),
        ),
    ]
